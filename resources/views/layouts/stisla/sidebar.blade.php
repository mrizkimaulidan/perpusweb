  ...
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      <li class="{{ Request::segment(2) === 'dashboard' ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('admin.dashboard.index') }}"><i class="fas fa-fire"></i> <span>Dashboard</span></a>
      </li>
      <li class="menu-header">Data Master</li>
      <li class="{{ Request::segment(2) === 'users' ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('admin.users.index') }}"><i class="far fa-user"></i> <span>Pengguna</span></a>
      </li>
      <li class="{{ Request::segment(2) === 'book-types' ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('admin.book-types.index') }}"><i class="far fa-bookmark"></i> <span>Kategori Buku</span></a>
      </li>
      ...
      <li class="nav-item dropdown {{ (Request::segment(2) === 'book-borrowers' ? 'active' : '') || Request::segment(2) === 'book-borrowers-history' ? 'active' : '' }}">
      ...
      <ul class="sidebar-menu">
        <li class="{{ Request::segment(2) === 'dashboard' ? 'active' : '' }}">
          <a class="nav-link" href="{{ route('anggota.dashboard.index') }}"><i class="fas fa-fire"></i> <span>Dashboard</span></a>
        </li>
