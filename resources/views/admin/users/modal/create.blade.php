<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="create-user-modal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <select class="form-control" name="role_id" id="role_id_create">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="email" class="form-control" name="email" id="email_create">
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="form-group">
                ...
                <textarea class="form-control" name="address" id="address_create" rows="3"></textarea>
              </div>
            </div>
          </div>
